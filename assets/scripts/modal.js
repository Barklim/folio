...
const genomusArr = [genomusTemp1, genomusTemp2, genomusTemp3, genomusTemp4, genomusTemp5, genomusTemp6, genomusTemp7, genomusTemp8, genomusTemp9, genomusTemp10, genomusTemp11];
const genomusMobileArr = [genomusTempMobile1, genomusTempMobile2, genomusTempMobile3, genomusTempMobile4, genomusTempMobile5, genomusTempMobile6, genomusTempMobile7, genomusTempMobile8, genomusTempMobile9, genomusTempMobile10];
const genomusAdminArr = [genomusAdminTemp1, genomusAdminTemp2, genomusAdminTemp3, genomusAdminTemp4, genomusAdminTemp5, genomusAdminTemp6, genomusAdminTemp7];
const genomusAdminMobileArr = [noImage];
...
var scrGenomusTemplater = document.getElementById("screenshots-genomus-templater");
var scrGenomus = document.getElementById("screenshots-genomus");
var scrGenomusAdmin = document.getElementById("screenshots-genomus-admin");
...
scrGenomusTemplater.onclick = function() {
  ...
  if (slidesPerViewVar === 1)
  {
    genomusTemplateMobileArr.forEach(function(item, i, arr) {
      swiper1.appendSlide(item);
    });
  } else {
    genomusTemplateArr.forEach(function(item, i, arr) {
      swiper1.appendSlide(item);
    });
  }
...
scrGenomus.onclick = function() {
  ...
  if (slidesPerViewVar === 1)
  {
    genomusMobileArr.forEach(function(item, i, arr) {
      swiper1.appendSlide(item);
    });
  } else {
    genomusArr.forEach(function(item, i, arr) {
      swiper1.appendSlide(item);
    });
  }
...
scrGenomusAdmin.onclick = function() {
  ...
  if (slidesPerViewVar === 1)
  {
    genomusAdminMobileArr.forEach(function(item, i, arr) {
      swiper1.appendSlide(item);
    });
  } else {
    genomusAdminArr.forEach(function(item, i, arr) {
      swiper1.appendSlide(item);
    });
  }
